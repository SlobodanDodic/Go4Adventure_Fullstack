...
export function HeaderCard({ data }) {
  const { classes, theme } = useStyles();
  const { coverImg, title, category, views, comments, link } = data;

  return (
    <Card p="lg" shadow="lg" className={classes.card} radius="md" component="a" href={link} target="_blank">
      <div className={classes.image} style={{ backgroundImage: `url(${coverImg})` }} />
      ...
      <div className={classes.content}>
        <div>
          ...
          <Group position="apart" spacing="xs">
            <Text size="sm" className={classes.category}>
              {category}
            </Text>
